class User < ActiveRecord::Base
  ...
  validates :full_name, format: { with: /\A\S[^0-9`!@#\$%\^&*+_=-]+\z/,
    message: "sólo permite caracteres alfabéticos y no puede comenzar con un espacio en blanco" } 
  validates :full_name, format: { without: /\s{2}/, 
    ...
    message: "debe contener entre 8 y 15 caracteres numéricos únicamente"}
