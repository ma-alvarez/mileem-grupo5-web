...
PublicationAttachment.create!([
  ...
  {publication_id: 3, image:  File.new(File.join(Rails.root, "/public/imagenesDePrueba/departamentos/6.jpg"))},
  ...
  {publication_id: 7, image:  File.new(File.join(Rails.root, "/public/imagenesDePrueba/casas/5.jpg"))},
  {publication_id: 7, image:  File.new(File.join(Rails.root, "/public/imagenesDePrueba/casas/6.jpg"))},
  {publication_id: 7, image:  File.new(File.join(Rails.root, "/public/imagenesDePrueba/departamentos/12.jpg"))},
  {publication_id: 7, image:  File.new(File.join(Rails.root, "/public/imagenesDePrueba/departamentos/15.jpg"))},
  {publication_id: 7, image:  File.new(File.join(Rails.root, "/public/imagenesDePrueba/departamentos/14.jpg"))},
  ...
  {publication_id: 7, image:  File.new(File.join(Rails.root, "/public/imagenesDePrueba/departamentos/1.jpg"))},
  {publication_id: 7, image:  File.new(File.join(Rails.root, "/public/imagenesDePrueba/casas/3.jpg"))},
  {publication_id: 7, image:  File.new(File.join(Rails.root, "/public/imagenesDePrueba/departamentos/2.jpg"))}
])
Zone.create!([
  {name: "Agronomía"},
  {name: "Almagro"},
